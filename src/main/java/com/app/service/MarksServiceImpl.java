...
public class MarksServiceImpl implements IMarksService {
	...
	@Override
	public int addOrUpdateMarksDetails(AddMarks m) {
		return marksedao.saveMarks(m.getCls(), m.getSubject(), m.getDate(), m.getObtmarks(), m.getTotal(),
				m.getRemark(), m.getExamid(), m.getMyrollno());
	}
